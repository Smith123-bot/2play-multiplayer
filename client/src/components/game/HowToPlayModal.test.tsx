 ...
 *
 * Every catalogue game renders its rules through this one component, so these tests
...
describe('HowToPlayContent', () => {
  it('renders every section for all catalogue games', () => {
    expect(ALL_GAME_METADATA.length).toBeGreaterThan(0);
