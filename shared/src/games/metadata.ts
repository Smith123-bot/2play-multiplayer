...
export const CONNECT_FOUR_METADATA = {
  id: 'connect-four',
  name: 'Connect Four',
  description: 'Drop discs into a classic seven-column board and connect four.',
  category: 'strategy' as const,
  icon: '🔴',
  thumbnail: '🔴',
  minPlayers: 2,
  ...
  estimatedDuration: 300,
  difficulty: 'easy' as const,
  controls: 'Tap a column or use the column buttons.',
  rules: [
    'The board is seven columns by six rows.',
  ...
  scoring: 'The winner receives 100 points.',
  winCondition: 'Connect four discs before the board fills.',
...
export const HANGMAN_METADATA = {
  id: 'hangman',
  name: 'Hangman',
  description: 'Solve five server-selected words before your attempts run out.',
  category: 'word' as const,
  icon: '🔤',
  thumbnail: '🔤',
  minPlayers: 2,
  ...
  estimatedDuration: 300,
  difficulty: 'easy' as const,
  controls: 'Choose one letter using the keyboard or letter buttons.',
  rules: [
    'The server selects each hidden word.',
    'Guess one unused letter at a time.',
    'Wrong guesses consume an attempt; repeated guesses are rejected.',
    'Five rounds are scored, then the highest score wins.',
  ],
  scoring: 'Correct letters score 10; remaining attempts add 5 when a word is solved.',
  winCondition: 'Have the highest total after five rounds.',
  tags: ['classic', 'word', 'letters'],
  hasRounds: true,
  defaultRounds: 5,
  featured: false,
  version: '1.0.0',
...
export const SOS_GAME_METADATA = {
  id: 'sos-game',
  name: 'SOS',
  description: 'Place S and O to create SOS lines on a five by five board.',
  category: 'strategy' as const,
  icon: '🆂',
  thumbnail: '🆂',
  minPlayers: 2,
  ...
  estimatedDuration: 300,
  difficulty: 'easy' as const,
  controls: 'Tap an empty cell, then choose S or O.',
  rules: [
    'Players place S or O on the 5 by 5 board.',
    'Every new SOS scores one point, including multiple lines from one move.',
    'Making at least one SOS grants another turn.',
    'When the board is full, the highest score wins; equal scores draw.',
  ],
  scoring: 'One point per newly completed horizontal, vertical, or diagonal SOS.',
  winCondition: 'Score the most SOS lines when the board is full.',
  tags: ['classic', 'board', 'strategy'],
  featured: false,
  version: '1.0.0',
} satisfies GameMetadata;
export const CHESS_METADATA = {
  id: 'chess',
  name: 'Chess',
  description: 'Play authentic chess with legal movement and special rules.',
  category: 'strategy' as const,
  icon: '♟️',
  thumbnail: '♟️',
  minPlayers: 2,
  ...
  controls: 'Tap a piece, then tap a legal destination. Promotion choices appear when needed.',
  rules: [
    'Standard eight by eight chess uses alternating white and black turns.',
    'Moves leaving your king in check are illegal.',
    'Castling, en passant, promotion, checkmate, stalemate, and threefold or fifty-move draws are supported.',
    'The server validates the complete position and every move.',
  ],
