...
export const PADDLE_DUEL_METADATA = {
  ...
  estimatedDuration: 180,
  difficulty: 'medium' as const,
  controls: 'Slide your paddle with W/S, the up/down arrow keys, the on-screen buttons or by dragging on your side of the arena.',
  rules: [
    ...
    'The longer the rally, the faster the ball — and your paddle speeds up with it so long rallies stay winnable.',
...
export const BRICK_BREAKER_METADATA = {
  ...
  estimatedDuration: 180,
  difficulty: 'medium' as const,
  controls: 'Slide your paddle with A/D, the left/right arrow keys, the on-screen buttons or by dragging on your arena.',
  rules: [
    'Each player breaks their own identical wall — the server simulates both balls.',
    'Bricks are worth more the higher they sit: 15 to 30 points.',
    'Chain bricks without touching your paddle to multiply them, up to x4.',
    'Broken bricks sometimes drop capsules — catch them with your paddle for a wide paddle, slow ball, extra life or bonus points.',
    'Missing the ball costs a life; you have three, then your run is over.',
    'Clearing a wall banks a 100-point bonus x level, grants an extra life and spawns a taller, faster wall. Clear all three walls to finish your run.',
  ],
  scoring: 'Brick points x combo multiplier (up to x4) + capsule bonuses + 100 x level per wall cleared.',
...
export const LUDO_METADATA = {
  ...
  difficulty: 'easy' as const,
  controls: 'Tap the dice to roll, then tap a highlighted token to move it. Star squares are safe havens.',
  rules: [
    ...
    'Landing on a lone enemy token sends it back to its yard. Star squares and pairs are protected.',
...
export const BLACK_BLAST_METADATA = {
  ...
  rules: [
    ...
    'Land pulses back to back to build a combo multiplier up to 4x — a live combo also widens your next blast. A pulse that hits nothing resets it.',
    'Every minute the arena escalates: fresh obstacles appear and energy respawns slower.',
